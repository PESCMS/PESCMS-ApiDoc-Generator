...
//此处为生成文档的目录，兼容使用的。
defined('PES_PATH') or define('PES_PATH', dirname(dirname(__FILE__)) . '/Traverse/');

defined('PES_TRUE_PATH') or define('PES_TRUE_PATH', dirname(dirname(__FILE__)) . '/');
...
require PES_CORE . 'Traverse.class.php';

$autoloader = new \Core\Traverse();
